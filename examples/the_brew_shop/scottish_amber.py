...
def main():
    ...
    recipe = {
        ...
        u"grains": [
            ...
            {u"name": u"Victory Malt", u"weight": 1.0, u"grain_type": u"specialty"},
        ],
        u"hops": [
            {u"name": u"Perle", u"weight": 1.0, u"boil_time": 60.0},
            {u"name": u"Perle", u"weight": 1.0, u"boil_time": 30.0},
        ],
        u"yeast": {u"name": u"Wyeast 1728"},
        u"data": {u"brew_house_yield": 0.458, u"units": u"imperial"},
    }
